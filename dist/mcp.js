...
import { DeleteSearchPresetOutputSchema, ListSearchPresetsOutputSchema, SaveSearchPresetOutputSchema, DeleteSearchPresetSchema, ListSearchPresetsSchema, SaveSearchPresetSchema, UpdateSessionOutputSchema, StatsOutputSchema, StartDebugSessionOutputSchema, SearchSessionsOutputSchema, RecordCommandOutputSchema, ListSessionsOutputSchema, ImportSessionsOutputSchema, SessionSchema, GetSessionContextOutputSchema, FindSimilarErrorsOutputSchema, ExportSessionsOutputSchema, DeleteSessionOutputSchema, CloseSessionOutputSchema, AddFixOutputSchema, AddFixSchema, CloseSessionSchema, CreateSessionSchema, DeleteSessionSchema, ExportSessionsSchema, FindSimilarErrorsSchema, GetSessionContextSchema, GetSessionSchema, GetDiagnosticsSchema, DiagnosticsOutputSchema, GetStatsSchema, ImportSessionsSchema, ListSessionsSchema, RecordCommandSchema, SearchSchema, UpdateSessionSchema } from './types.js';
...
export function createRuntime(dbPath) {
...
export function createDebugRecorderServer(runtime) {
    const server = new McpServer({ name: 'debug-recorder-mcp', version: getVersion() }, { capabilities: { logging: {} } });
    ...
    const registrations = [
        ...
        },
        {
            ...
            description: 'Record a fix attempt for a debug session. If it worked, session is marked resolved.',
        ...
        },
        {
            ...
            description: 'Record a terminal command and its output during a debug session',
        ...
        },
        {
            ...
            description: 'Search past debug sessions by error message, keyword, or description',
        ...
        },
        {
            ...
            description: 'Save or update a reusable search preset with query, filters, and result limit',
        ...
        },
        {
            ...
            description: 'Find past sessions with similar error messages — answers "have I seen this before?"',
        ...
        },
        {
            ...
            description: 'Get full details of a debug session including all fixes and commands',
        ...
        },
        {
            ...
            description: 'Update title, description, or tags of an existing debug session',
        ...
        },
        {
            ...
            description: 'Permanently delete a debug session and all related fixes and commands',
        ...
        },
        {
            ...
            description: 'Get a redacted operational diagnostics snapshot for troubleshooting local runtime issues',
        ...
        },
        {
            ...
            description: 'Import sessions previously exported from debug-recorder-mcp',
        ...
        },
        {
            ...
            description: 'Get a structured summary of a debug session formatted for AI context',
    ...
    for (const registration of registrations) {
        const handler = handlers[registration.handler];
